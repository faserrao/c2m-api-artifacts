...
namespace C2M.Api.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new SubmitSingleDocWithTemplateParamsRequestOneOfJsonConverter());
            _jsonOptions.Converters.Add(new SubmitSingleDocWithTemplateParamsRequestOneOf1JsonConverter());
            _jsonOptions.Converters.Add(new SubmitSingleDocWithTemplateParamsRequestOneOf2JsonConverter());
