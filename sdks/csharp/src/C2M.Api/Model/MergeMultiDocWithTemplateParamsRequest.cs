...
namespace C2M.Api.Model
{
    ...
    public partial class MergeMultiDocWithTemplateParamsRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MergeMultiDocWithTemplateParamsRequest(List<DocumentSourceIdentifier> documentsToMerge, RecipientAddressSource recipientAddressSource, string jobTemplate, PaymentDetails paymentDetails, Option<List<string>?> tags = default)
        {
    ...
    public class MergeMultiDocWithTemplateParamsRequestJsonConverter : JsonConverter<MergeMultiDocWithTemplateParamsRequest>
    {
        ...
        public override MergeMultiDocWithTemplateParamsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new MergeMultiDocWithTemplateParamsRequest(documentsToMerge.Value!, recipientAddressSource.Value!, jobTemplate.Value!, paymentDetails.Value!, tags);
        }
