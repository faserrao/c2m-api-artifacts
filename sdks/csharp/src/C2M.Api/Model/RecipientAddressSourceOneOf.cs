...
namespace C2M.Api.Model
{
    ...
    /// </summary>
    public partial class RecipientAddressSourceOneOf : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RecipientAddressSourceOneOf" />
    /// </summary>
    public class RecipientAddressSourceOneOfJsonConverter : JsonConverter<RecipientAddressSourceOneOf>
    {
        /// <summary>
        /// Deserializes json to <see cref="RecipientAddressSourceOneOf" />
        /// </summary>
        ...
        public override RecipientAddressSourceOneOf Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="RecipientAddressSourceOneOf" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="recipientAddressSourceOneOf"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RecipientAddressSourceOneOf recipientAddressSourceOneOf, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, recipientAddressSourceOneOf, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RecipientAddressSourceOneOf" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="recipientAddressSourceOneOf"></param>
        /// <param name="jsonSerializerOptions"></param>
