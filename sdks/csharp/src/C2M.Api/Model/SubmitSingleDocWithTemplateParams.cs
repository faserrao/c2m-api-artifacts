...
namespace C2M.Api.Model
{
    ...
    /// </summary>
    public partial class SubmitSingleDocWithTemplateParams : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitSingleDocWithTemplateParams" /> class.
        /// </summary>
        /// <param name="submitSingleDocWithTemplateParamsRequestOneOf"></param>
        public SubmitSingleDocWithTemplateParams(SubmitSingleDocWithTemplateParamsRequestOneOf submitSingleDocWithTemplateParamsRequestOneOf)
        {
        ...
        public SubmitSingleDocWithTemplateParams(SubmitSingleDocWithTemplateParamsRequestOneOf1 submitSingleDocWithTemplateParamsRequestOneOf1)
        {
        ...
        public SubmitSingleDocWithTemplateParams(SubmitSingleDocWithTemplateParamsRequestOneOf2 submitSingleDocWithTemplateParamsRequestOneOf2)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitSingleDocWithTemplateParams {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SubmitSingleDocWithTemplateParams" />
    /// </summary>
    public class SubmitSingleDocWithTemplateParamsJsonConverter : JsonConverter<SubmitSingleDocWithTemplateParams>
    {
        /// <summary>
        /// Deserializes json to <see cref="SubmitSingleDocWithTemplateParams" />
        /// </summary>
        ...
        public override SubmitSingleDocWithTemplateParams Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (submitSingleDocWithTemplateParamsRequestOneOf != null)
                return new SubmitSingleDocWithTemplateParams(submitSingleDocWithTemplateParamsRequestOneOf);

            if (submitSingleDocWithTemplateParamsRequestOneOf1 != null)
                return new SubmitSingleDocWithTemplateParams(submitSingleDocWithTemplateParamsRequestOneOf1);

            if (submitSingleDocWithTemplateParamsRequestOneOf2 != null)
                return new SubmitSingleDocWithTemplateParams(submitSingleDocWithTemplateParamsRequestOneOf2);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="SubmitSingleDocWithTemplateParams" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitSingleDocWithTemplateParams"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SubmitSingleDocWithTemplateParams submitSingleDocWithTemplateParams, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, submitSingleDocWithTemplateParams, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubmitSingleDocWithTemplateParams" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitSingleDocWithTemplateParams"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SubmitSingleDocWithTemplateParams submitSingleDocWithTemplateParams, JsonSerializerOptions jsonSerializerOptions)
        {
