...
namespace C2M.Api.Model
{
    ...
    /// </summary>
    public partial class SubmitSingleDocWithTemplateParamsRequestOneOf2 : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="SubmitSingleDocWithTemplateParamsRequestOneOf2" />
    /// </summary>
    public class SubmitSingleDocWithTemplateParamsRequestOneOf2JsonConverter : JsonConverter<SubmitSingleDocWithTemplateParamsRequestOneOf2>
    {
        /// <summary>
        /// Deserializes json to <see cref="SubmitSingleDocWithTemplateParamsRequestOneOf2" />
        /// </summary>
        ...
        public override SubmitSingleDocWithTemplateParamsRequestOneOf2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!recipientAddressSources.IsSet)
                throw new ArgumentException("Property is required for class SubmitSingleDocWithTemplateParamsRequestOneOf2.", nameof(recipientAddressSources));
        ...
        /// <summary>
        /// Serializes a <see cref="SubmitSingleDocWithTemplateParamsRequestOneOf2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitSingleDocWithTemplateParamsRequestOneOf2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SubmitSingleDocWithTemplateParamsRequestOneOf2 submitSingleDocWithTemplateParamsRequestOneOf2, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, submitSingleDocWithTemplateParamsRequestOneOf2, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubmitSingleDocWithTemplateParamsRequestOneOf2" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="submitSingleDocWithTemplateParamsRequestOneOf2"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SubmitSingleDocWithTemplateParamsRequestOneOf2 submitSingleDocWithTemplateParamsRequestOneOf2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (submitSingleDocWithTemplateParamsRequestOneOf2.TagsOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, submitSingleDocWithTemplateParamsRequestOneOf2.Tags, jsonSerializerOptions);
            }
        }
    }
}
