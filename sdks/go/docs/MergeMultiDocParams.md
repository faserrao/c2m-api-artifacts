...
`func NewMergeMultiDocParams(documentsToMerge []DocumentSourceIdentifier, recipientAddressSource RecipientAddressSource, paymentDetails PaymentDetails, ) *MergeMultiDocParams`
...
`func (o *MergeMultiDocParams) GetPaymentDetails() PaymentDetails`

GetPaymentDetails returns the PaymentDetails field if non-nil, zero value otherwise.

### GetPaymentDetailsOk

`func (o *MergeMultiDocParams) GetPaymentDetailsOk() (*PaymentDetails, bool)`
...
`func (o *MergeMultiDocParams) SetPaymentDetails(v PaymentDetails)`
