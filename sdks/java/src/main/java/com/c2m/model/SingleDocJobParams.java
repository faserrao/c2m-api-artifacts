...
public class SingleDocJobParams {
  ...
  public SingleDocJobParams() {
  }

  public SingleDocJobParams documentSourceIdentifier(@javax.annotation.Nonnull DocumentSourceIdentifier documentSourceIdentifier) {
  ...
  public SingleDocJobParams recipientAddressSources(@javax.annotation.Nonnull List<RecipientAddressSource> recipientAddressSources) {
    this.recipientAddressSources = recipientAddressSources;
    return this;
  }

  public SingleDocJobParams addRecipientAddressSourcesItem(RecipientAddressSource recipientAddressSourcesItem) {
  ...
  public SingleDocJobParams jobOptions(@javax.annotation.Nonnull JobOptions jobOptions) {
  ...
  public SingleDocJobParams paymentDetails(@javax.annotation.Nonnull PaymentDetails paymentDetails) {
  ...
  public SingleDocJobParams tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public SingleDocJobParams addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    SingleDocJobParams singleDocJobParams = (SingleDocJobParams) o;
    return Objects.equals(this.documentSourceIdentifier, singleDocJobParams.documentSourceIdentifier) &&
        Objects.equals(this.recipientAddressSources, singleDocJobParams.recipientAddressSources) &&
        Objects.equals(this.jobOptions, singleDocJobParams.jobOptions) &&
        Objects.equals(this.paymentDetails, singleDocJobParams.paymentDetails) &&
        Objects.equals(this.tags, singleDocJobParams.tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SingleDocJobParams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SingleDocJobParams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SingleDocJobParams is not found in the empty JSON string", SingleDocJobParams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SingleDocJobParams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SingleDocJobParams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SingleDocJobParams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SingleDocJobParams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SingleDocJobParams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SingleDocJobParams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SingleDocJobParams.class));

       return (TypeAdapter<T>) new TypeAdapter<SingleDocJobParams>() {
           @Override
           public void write(JsonWriter out, SingleDocJobParams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SingleDocJobParams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SingleDocJobParams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SingleDocJobParams
   * @throws IOException if the JSON string is invalid with respect to SingleDocJobParams
   */
  public static SingleDocJobParams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SingleDocJobParams.class);
  }

  /**
   * Convert an instance of SingleDocJobParams to an JSON string
   *
   * @return JSON string
   */
