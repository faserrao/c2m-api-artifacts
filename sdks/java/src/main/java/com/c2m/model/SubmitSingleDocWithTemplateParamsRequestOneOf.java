...
public class SubmitSingleDocWithTemplateParamsRequestOneOf {
  ...
  public SubmitSingleDocWithTemplateParamsRequestOneOf jobTemplate(@javax.annotation.Nonnull String jobTemplate) {
  ...
  public SubmitSingleDocWithTemplateParamsRequestOneOf tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public SubmitSingleDocWithTemplateParamsRequestOneOf addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    SubmitSingleDocWithTemplateParamsRequestOneOf submitSingleDocWithTemplateParamsRequestOneOf = (SubmitSingleDocWithTemplateParamsRequestOneOf) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubmitSingleDocWithTemplateParamsRequestOneOf
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubmitSingleDocWithTemplateParamsRequestOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubmitSingleDocWithTemplateParamsRequestOneOf is not found in the empty JSON string", SubmitSingleDocWithTemplateParamsRequestOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubmitSingleDocWithTemplateParamsRequestOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubmitSingleDocWithTemplateParamsRequestOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubmitSingleDocWithTemplateParamsRequestOneOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubmitSingleDocWithTemplateParamsRequestOneOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubmitSingleDocWithTemplateParamsRequestOneOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubmitSingleDocWithTemplateParamsRequestOneOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmitSingleDocWithTemplateParamsRequestOneOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmitSingleDocWithTemplateParamsRequestOneOf>() {
           @Override
           public void write(JsonWriter out, SubmitSingleDocWithTemplateParamsRequestOneOf value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SubmitSingleDocWithTemplateParamsRequestOneOf read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SubmitSingleDocWithTemplateParamsRequestOneOf given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubmitSingleDocWithTemplateParamsRequestOneOf
   * @throws IOException if the JSON string is invalid with respect to SubmitSingleDocWithTemplateParamsRequestOneOf
   */
  public static SubmitSingleDocWithTemplateParamsRequestOneOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubmitSingleDocWithTemplateParamsRequestOneOf.class);
  }

  /**
   * Convert an instance of SubmitSingleDocWithTemplateParamsRequestOneOf to an JSON string
   *
   * @return JSON string
   */
