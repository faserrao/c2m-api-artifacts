...
class MultiPdfWithCaptureParams {
    ...
    constructor(addressCapturePdfs, paymentDetails) { 
        ...
        MultiPdfWithCaptureParams.initialize(this, addressCapturePdfs, paymentDetails);
    }
...
MultiPdfWithCaptureParams.RequiredProperties = ["addressCapturePdfs", "paymentDetails"];
