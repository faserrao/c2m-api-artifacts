...
class SingleDocJobParams {
    ...
    constructor(documentSourceIdentifier, recipientAddressSources, jobOptions, paymentDetails) { 
        ...
        SingleDocJobParams.initialize(this, documentSourceIdentifier, recipientAddressSources, jobOptions, paymentDetails);
    }
...
SingleDocJobParams.RequiredProperties = ["documentSourceIdentifier", "recipientAddressSources", "jobOptions", "paymentDetails"];
