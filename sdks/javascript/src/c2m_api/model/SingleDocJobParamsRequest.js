...
/**
 * The SingleDocJobParamsRequest model module.
 * @module c2m_api/model/SingleDocJobParamsRequest
 * @version 2.0.0
 */
class SingleDocJobParamsRequest {
    /**
     * Constructs a new <code>SingleDocJobParamsRequest</code>.
     * @alias module:c2m_api/model/SingleDocJobParamsRequest
     ...
     */
    constructor(documentSourceIdentifier, recipientAddressSources, jobOptions, paymentDetails) { 
        
        SingleDocJobParamsRequest.initialize(this, documentSourceIdentifier, recipientAddressSources, jobOptions, paymentDetails);
    }
     ...
     */
    static initialize(obj, documentSourceIdentifier, recipientAddressSources, jobOptions, paymentDetails) { 
    ...
    /**
     * Constructs a <code>SingleDocJobParamsRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:c2m_api/model/SingleDocJobParamsRequest} obj Optional instance to populate.
     * @return {module:c2m_api/model/SingleDocJobParamsRequest} The populated <code>SingleDocJobParamsRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SingleDocJobParamsRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>SingleDocJobParamsRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SingleDocJobParamsRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SingleDocJobParamsRequest.RequiredProperties) {
...
SingleDocJobParamsRequest.RequiredProperties = ["documentSourceIdentifier", "recipientAddressSources", "jobOptions", "paymentDetails"];

/**
 * @member {module:c2m_api/model/DocumentSourceIdentifier} documentSourceIdentifier
 */
SingleDocJobParamsRequest.prototype['documentSourceIdentifier'] = undefined;

/**
 * @member {Array.<module:c2m_api/model/RecipientAddressSource>} recipientAddressSources
 */
SingleDocJobParamsRequest.prototype['recipientAddressSources'] = undefined;

/**
 * @member {module:c2m_api/model/JobOptions} jobOptions
 */
SingleDocJobParamsRequest.prototype['jobOptions'] = undefined;

/**
 * @member {module:c2m_api/model/PaymentDetails} paymentDetails
 */
SingleDocJobParamsRequest.prototype['paymentDetails'] = undefined;

/**
 * @member {Array.<String>} tags
 */
SingleDocJobParamsRequest.prototype['tags'] = undefined;
...
export default SingleDocJobParamsRequest;
