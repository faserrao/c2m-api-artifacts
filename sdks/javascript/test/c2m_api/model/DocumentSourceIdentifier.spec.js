...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.DocumentSourceIdentifier();
  });
  ...
  describe('DocumentSourceIdentifier', function() {
    it('should create an instance of DocumentSourceIdentifier', function() {
      // uncomment below and update the code to test DocumentSourceIdentifier
