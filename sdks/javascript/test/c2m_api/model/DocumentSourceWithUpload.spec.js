...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.DocumentSourceWithUpload();
  });
  ...
  describe('DocumentSourceWithUpload', function() {
    it('should create an instance of DocumentSourceWithUpload', function() {
      // uncomment below and update the code to test DocumentSourceWithUpload
      //var instance = new C2MApiV2AuthOverlay.DocumentSourceWithUpload();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.DocumentSourceWithUpload);
    });
