...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.MergeMultiDocParams();
  });
  ...
  describe('MergeMultiDocParams', function() {
    it('should create an instance of MergeMultiDocParams', function() {
      // uncomment below and update the code to test MergeMultiDocParams
      //var instance = new C2MApiV2AuthOverlay.MergeMultiDocParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.MergeMultiDocParams);
    });
