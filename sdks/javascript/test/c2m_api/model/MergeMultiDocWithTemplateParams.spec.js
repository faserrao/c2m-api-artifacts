...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.MergeMultiDocWithTemplateParams();
  });
  ...
  describe('MergeMultiDocWithTemplateParams', function() {
    it('should create an instance of MergeMultiDocWithTemplateParams', function() {
      ...
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.MergeMultiDocWithTemplateParams);
    });
