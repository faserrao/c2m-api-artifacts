...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.MultiPdfWithCaptureParams();
  });
  ...
  describe('MultiPdfWithCaptureParams', function() {
    it('should create an instance of MultiPdfWithCaptureParams', function() {
      // uncomment below and update the code to test MultiPdfWithCaptureParams
      //var instance = new C2MApiV2AuthOverlay.MultiPdfWithCaptureParams();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.MultiPdfWithCaptureParams);
    });
