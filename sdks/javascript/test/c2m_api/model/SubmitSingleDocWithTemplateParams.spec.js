...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParams();
  });
  ...
  describe('SubmitSingleDocWithTemplateParams', function() {
    it('should create an instance of SubmitSingleDocWithTemplateParams', function() {
      ...
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParams);
    });
