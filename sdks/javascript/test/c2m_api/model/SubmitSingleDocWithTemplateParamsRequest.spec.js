...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequest();
  });
  ...
  describe('SubmitSingleDocWithTemplateParamsRequest', function() {
    it('should create an instance of SubmitSingleDocWithTemplateParamsRequest', function() {
      // uncomment below and update the code to test SubmitSingleDocWithTemplateParamsRequest
      //var instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequest();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequest);
    });
