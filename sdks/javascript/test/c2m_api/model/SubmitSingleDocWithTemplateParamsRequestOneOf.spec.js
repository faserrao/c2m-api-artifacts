...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf();
  });
  ...
  describe('SubmitSingleDocWithTemplateParamsRequestOneOf', function() {
    it('should create an instance of SubmitSingleDocWithTemplateParamsRequestOneOf', function() {
      // uncomment below and update the code to test SubmitSingleDocWithTemplateParamsRequestOneOf
      //var instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf);
    });
