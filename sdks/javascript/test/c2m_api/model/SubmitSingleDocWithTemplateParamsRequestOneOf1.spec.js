...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf1();
  });
  ...
  describe('SubmitSingleDocWithTemplateParamsRequestOneOf1', function() {
    it('should create an instance of SubmitSingleDocWithTemplateParamsRequestOneOf1', function() {
      // uncomment below and update the code to test SubmitSingleDocWithTemplateParamsRequestOneOf1
      //var instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf1();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf1);
    });
