...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf2();
  });
  ...
  describe('SubmitSingleDocWithTemplateParamsRequestOneOf2', function() {
    it('should create an instance of SubmitSingleDocWithTemplateParamsRequestOneOf2', function() {
      // uncomment below and update the code to test SubmitSingleDocWithTemplateParamsRequestOneOf2
      //var instance = new C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf2();
      //expect(instance).to.be.a(C2MApiV2AuthOverlay.SubmitSingleDocWithTemplateParamsRequestOneOf2);
    });
