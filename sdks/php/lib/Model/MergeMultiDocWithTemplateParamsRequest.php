...
/**
 * MergeMultiDocWithTemplateParamsRequest Class Doc Comment
 *
 * @category Class
 * @package  C2MApi
 * @author   OpenAPI Generator team
 ...
 */
class MergeMultiDocWithTemplateParamsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'mergeMultiDocWithTemplateParams_request';
    ...
    */
    ...
    /**
     * Gets documents_to_merge
     *
     * @return \C2MApi\Model\DocumentSourceIdentifier[]
     */
    public function getDocumentsToMerge()
    {
        return $this->container['documents_to_merge'];
    }

    /**
     * Sets documents_to_merge
     *
     * @param \C2MApi\Model\DocumentSourceIdentifier[] $documents_to_merge documents_to_merge
     *
     * @return self
     */
    public function setDocumentsToMerge($documents_to_merge)
    {
        if (is_null($documents_to_merge)) {
            throw new \InvalidArgumentException('non-nullable documents_to_merge cannot be null');
        }
        $this->container['documents_to_merge'] = $documents_to_merge;
     ...
     * Sets job_template
     *
     * @param string $job_template job_template
     *
     * @return self
     */
