...
class MergeMultiDocParamsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["documentsToMerge", "recipientAddressSource", "paymentDetails", "tags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in documents_to_merge (list)
        _items = []
        if self.documents_to_merge:
            for _item_documents_to_merge in self.documents_to_merge:
