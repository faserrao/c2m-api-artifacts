...
class SingleDocJobParamsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["documentSourceIdentifier", "recipientAddressSources", "jobOptions", "paymentDetails", "tags"]
