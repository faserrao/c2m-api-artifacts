...
class SplitPdfWithCaptureParamsRequest(BaseModel):
    """
    SplitPdfWithCaptureParamsRequest
    """ # noqa: E501
    document_source_identifier: DocumentSourceIdentifier = Field(alias="documentSourceIdentifier")
    embedded_extraction_specs: List[ExtractionSpec] = Field(alias="embeddedExtractionSpecs")
    payment_details: PaymentDetails = Field(alias="paymentDetails")
    tags: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["documentSourceIdentifier", "embeddedExtractionSpecs", "paymentDetails", "tags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in embedded_extraction_specs (list)
        _items = []
        if self.embedded_extraction_specs:
            for _item_embedded_extraction_specs in self.embedded_extraction_specs:
                if _item_embedded_extraction_specs:
                    _items.append(_item_embedded_extraction_specs.to_dict())
            _dict['embeddedExtractionSpecs'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "embeddedExtractionSpecs": [ExtractionSpec.from_dict(_item) for _item in obj["embeddedExtractionSpecs"]] if obj.get("embeddedExtractionSpecs") is not None else None,
