...
class SubmitSingleDocWithTemplateParamsRequestOneOf2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["jobTemplate", "paymentDetails", "tags", "documentSourceIdentifier", "recipientAddressSources"]
