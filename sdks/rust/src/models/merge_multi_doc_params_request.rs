...
impl MergeMultiDocParamsRequest {
    pub fn new(documents_to_merge: Vec<models::DocumentSourceIdentifier>, recipient_address_source: models::RecipientAddressSource, payment_details: models::PaymentDetails) -> MergeMultiDocParamsRequest {
