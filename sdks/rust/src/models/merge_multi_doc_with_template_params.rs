...
impl MergeMultiDocWithTemplateParams {
    pub fn new(documents_to_merge: Vec<models::DocumentSourceIdentifier>, recipient_address_source: models::RecipientAddressSource, job_template: String, payment_details: models::PaymentDetails) -> MergeMultiDocWithTemplateParams {
