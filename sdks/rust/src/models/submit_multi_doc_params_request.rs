...
impl SubmitMultiDocParamsRequest {
    pub fn new(items: Vec<models::SubmitMultiDocWithTemplateParamsRequestItemsInner>, job_options: models::JobOptions, payment_details: models::PaymentDetails) -> SubmitMultiDocParamsRequest {
