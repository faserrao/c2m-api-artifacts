...
public struct MergeMultiDocParams: Codable, JSONEncodable, Hashable {
    ...
    public init(documentsToMerge: [DocumentSourceIdentifier], recipientAddressSource: RecipientAddressSource, paymentDetails: PaymentDetails, tags: [String]? = nil) {
