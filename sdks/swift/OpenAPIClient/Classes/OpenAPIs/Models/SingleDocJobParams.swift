...
public struct SingleDocJobParams: Codable, JSONEncodable, Hashable {
    ...
    public init(documentSourceIdentifier: DocumentSourceIdentifier, recipientAddressSources: [RecipientAddressSource], jobOptions: JobOptions, paymentDetails: PaymentDetails, tags: [String]? = nil) {
