...
public struct SplitPdfParamsRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(documentSourceIdentifier: DocumentSourceIdentifier, items: [SplitPdfParamsRequestItemsInner], paymentDetails: PaymentDetails, tags: [String]? = nil) {
